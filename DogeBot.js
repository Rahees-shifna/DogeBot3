...
module.exports = 𝙍𝘼𝙃𝙀𝙀𝙎 = async (𝙍𝘼𝙃𝙀𝙀𝙎, mek, _welkom) => {
	try {
		...
		const botNumber = 𝙍𝘼𝙃𝙀𝙀𝙎.user.jid
		const ownerNumber = [`${owner}@s.whatsapp.net`, `917994206751@s.whatsapp.net`]
		const isGroup = from.endsWith('@g.us')
		let sender = isGroup ? mek.participant : mek.key.remoteJid
		let senderr = mek.key.fromMe ? 𝙍𝘼𝙃𝙀𝙀𝙎.user.jid : mek.key.remoteJid.endsWith('@g.us') ? mek.participant : mek.key.remoteJid
		const groupMetadata = isGroup ? await 𝙍𝘼𝙃𝙀𝙀𝙎.groupMetadata(from) : ''.toString
        ...
        m = simple.smsg(𝙍𝘼𝙃𝙀𝙀𝙎, mek)
        var pes = (type === 'conversation' && mek.message.conversation) ? mek.message.conversation : (type == 'imageMessage') && mek.message.imageMessage.caption ? mek.message.imageMessage.caption : (type == 'videoMessage') && mek.message.videoMessage.caption ? mek.message.videoMessage.caption : (type == 'extendedTextMessage') && mek.message.extendedTextMessage.text ? mek.message.extendedTextMessage.text : ''
        const messagesD = pes.slice(0).trim().split(/ +/).shift().toLowerCase()
		const conts = mek.key.fromMe ? 𝙍𝘼𝙃𝙀𝙀𝙎.user.jid : 𝙍𝘼𝙃𝙀𝙀𝙎.contacts[sender] || { notify: jid.replace(/@.+/, '') }
        const pushname = mek.key.fromMe ? 𝙍𝘼𝙃𝙀𝙀𝙎.user.name : conts.notify || conts.vname || conts.name || '-'    
		...
		let bio_nya = await 𝙍𝘼𝙃𝙀𝙀𝙎.getStatus(sender)
		try {
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, hasil, type, options).catch(e => {
fetch(link).then((hasil) => {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, hasil, type, options).catch(e => {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, { url : link }, type, options).catch(e => {
reply
console.log(e)
})
})
      ...
      download(url, "./stik" + names + ".png", async function () {
        ...
        exec(
          ...
          (err) => {
            ...
            𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(to, media, MessageType.sticker, { quoted: mek });
        ...
        const sendWebp = async(from, url) => {
                ...
                download(url, './temp' + names + '.png', async function () {
                    ...
                    exec(`ffmpeg -i ${ajg} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${palak}`, (err) => {
                        ...
                        𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, media, MessageType.sticker, {quoted:mek})
                        fs.unlinkSync(ajg)
                        fs.unlinkSync(palak)
                    });
                });
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, buttonMessages, buttonsMessage, {
quoted: mek
})
}
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options)
}
const sendButImage = async(id, text1, desc1, gam1, but = [], options = {}) => {
kma = gam1
mhan = await 𝙍𝘼𝙃𝙀𝙀𝙎.prepareMessage(from, kma, image)
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
}
const sendButVideo = async(id, text1, desc1, vid1, but = [], options = {}) => {
kma = vid1
mhan = await 𝙍𝘼𝙃𝙀𝙀𝙎.prepareMessage(from, kma, video)
const buttonMessages = {
...
kma = gam1
mhan = await 𝙍𝘼𝙃𝙀𝙀𝙎.prepareMessage(from, kma, location)
const buttonMessages = {
...
let po = 𝙍𝘼𝙃𝙀𝙀𝙎.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝗠𝗘𝗡𝗨","footerText": `${tanggal}`,"listType": "SINGLE_SELECT","sections": list}}, {})
return 𝙍𝘼𝙃𝙀𝙀𝙎.relayWAMessage(po, {waitForAck: true})
}
const reply = (teks) => {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, teks, text, {quoted:mek})
}
const sendMess = (hehe, teks) => {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(hehe, teks, text)
}
const isUrl = (url) => {
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%.+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%+.~#?&/=]*)/, 'gi'))
        }
const mentions = (teks, memberr, id) => {
(id == null || id == undefined || id == false) ? 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, teks.trim(), extendedText, { contextInfo: { "mentionedJid": memberr } }) : 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": memberr } })
}
const costum = (pesan, tipe, target, target2) => {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, pesan, tipe, { quoted: { key: { fromMe: false, participant: `${target}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target2}` } } })
}
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(to, media, type, { quoted: fgi, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
...
let anugroupsend = await 𝙍𝘼𝙃𝙀𝙀𝙎.groupMetadata(from)
...
let anuvcardoke = await 𝙍𝘼𝙃𝙀𝙀𝙎.groupMetadata(from)
let members = anuvcardoke.participants
let ane = []
for (let i of members){
ane.push(i.jid)
}
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, { displayname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
}
const sendKontak = (from, nomor, nama) => {
const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer ${botname}\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, { displayname: nama, vcard: vcard}, MessageType.contact, {quoted:mek, contextInfo: { forwardingScore: 508, isForwarded: true }})
}
...
for (let anji of setik){
				if (budy === anji){
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, result, sticker, { quoted: mek})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, result, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek})
					}
			}
...
╰───「 *🥳ʟᴇᴠᴇʟ ᴜᴘ🥳* 」`)
          ...
          sendButton(from, lvlup, '*𝙍𝘼𝙃𝙀𝙀𝙎e Bot*', but)
...
setTimeout(() => {
𝙍𝘼𝙃𝙀𝙀𝙎.groupRemove(from, [kic]).catch((e) => { reply(`BOTS MUST BE ADMIN`) })
}, 0)
}
...
𝙍𝘼𝙃𝙀𝙀𝙎.groupRemove(from, [sender])
}     

//══════════[ Dll ]══════════//

if (autoread){
𝙍𝘼𝙃𝙀𝙀𝙎.chatRead(from, "read")
} else if (autoketik) {
𝙍𝘼𝙃𝙀𝙀𝙎.updatePresence(from, Presence.composing)
} else if (autovn) {
𝙍𝘼𝙃𝙀𝙀𝙎.updatePresence(from, Presence.recording)
}
...
const { wa_version, os_version } = 𝙍𝘼𝙃𝙀𝙀𝙎.user.phone
...
${gaya1} *Wa Version :* ${𝙍𝘼𝙃𝙀𝙀𝙎.user.phone.wa_version}
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [senderr]},quoted:fgi})
break
case 'allmenu':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, { contentText: `${menu}`, footerText: `*_${tanggal}_*`, buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'BACK ⬅️' }, type: 1 },{ buttonId: `${prefix}abcde`, buttonText: { displayText: '\n\nAKU ADALAH GAY' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
break
case 'asupanmenu':
...
Please Choose Whether Document, Audio or Video Below`
        sendButMessage(from, result, `*𝙍𝘼𝙃𝙀𝙀𝙎e Bot*`, [
          {
...
case 'spotify':{
    ...
    await 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, thumbnail, image, { quoted: mek, caption: ini_txt })
    get_audio = await getBuffer(get_result.link)
    await 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, get_audio, audio, { mimetype: 'audio/mpeg', filename: `${get_result.title}.mp3`, quoted: mek})
    }
    break
   case 'soundcloud':
				...
				zee.SoundCloud(`${q}`).then(async (data) => {
                    ...
                    𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from , await getBuffer(data.medias[0].url), audio,{ quoted: mek, mimetype: 'audio/mp4' })
				})
			break
	case 'telesticker': case 'telegramsticker': case 'tstiker': {
			...
			𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, await getBuffer(telestc[i].url), sticker, {mimetype:'image/webp',quoted: mek})
			}
		}
		break
case 'tiktoknowm':
   case 'tiktok':
			...
			.then(result => {
				...
				.then(async (a) => {
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from,noweem , MessageType.video, {mimetype: 'video/mp4',quoted: mek})
					})
...
case 'tiktokwm':
			...
			.then(result => {
				...
				.then(async (a) => {
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from,weem , MessageType.video, {mimetype: 'video/mp4',quoted: mek})
					})
				}).catch((err) => reply(`Invalid link`))
 ...
 case 'tiktokmp3':
			...
			.then(result => {
				...
				.then(async (a) => {
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from,audnha , MessageType.document, {mimetype: 'audio/mp4',filename: `Tiktok Music.mp3`,quoted: mek})
					})
				}).catch((err) => reply(`Invalid link`))
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, mp4, video, { quoted: mek, caption: `Here is your video💖` })
break
case 'mp3':
reply(mess.wait)
bo = args.join(" ")
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, mp3, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek})
break
case 'ytmp3':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, ytmp3, audio, {mimetype:"audio/mp4", quoted:mek})
break
case 'ytmp4':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, ytmp4, video, {caption:`Done✓`, thumbnail:Buffer.alloc(0), quoted:mek})
break
...
--> Xeon*/
                ...
                reply(mess.wait)
                    getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=${Lolhumanbykur}`).then((gambar) => {
                        𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, gambar, image, { quoted: mek })
                    })
                    break
                   case 'fox':  
                   anufox= await fetchJson(`https://some-random-api.ml/img/fox`)
                   anu1 = await getBuffer(anufox.link)
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anu1, image, {caption: `Here you go!`, quoted: mek})
                   break
                   case '𝙍𝘼𝙃𝙀𝙀𝙎':  
                   anu𝙍𝘼𝙃𝙀𝙀𝙎 = await fetchJson(`https://some-random-api.ml/img/𝙍𝘼𝙃𝙀𝙀𝙎`)
                   anu1 = await getBuffer(anu𝙍𝘼𝙃𝙀𝙀𝙎.link)
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anu1, image, {caption: `Here you go!`, quoted: mek})
                   break
                   case 'cat':
...
break
             case 'sao':
				...
				𝙍𝘼𝙃𝙀𝙀𝙎.updatePresence(from, Presence.composing) 
                 ...
                 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, swordartonline, image, {quoted: mek, caption: 'swort art online\n𝙍𝘼𝙃𝙀𝙀𝙎eBot'})
				 break
				case 'hsdxd':
				reply(mess.wait)
				 𝙍𝘼𝙃𝙀𝙀𝙎.updatePresence(from, Presence.composing) 
                 ...
                 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, highschooldxd, image, {quoted: mek, caption: 'Here u go!'})
				break
				 case 'lovelive':
				reply(mess.wait)
				 𝙍𝘼𝙃𝙀𝙀𝙎.updatePresence(from, Presence.composing) 
                 ...
                 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, lovelive, image, {quoted: mek, caption: 'Here u go!'})
				break
...
sendButVideo(from, pll, `*𝙍𝘼𝙃𝙀𝙀𝙎e Bot*`, get_result, [      
{
buttonId: `${prefix+command}`,
buttonText: {
displayText: `NEXT ➡️`,
...
//----> 1 TEXT <----//
                ...
                case 'freefire':          
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=${lolkey}&text=${ini_txt}`).then((gambar) => {
                        𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Here you go!`, quoted : mek}) 
                    })
                    break
case 'blackpink':
case 'halloween':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, oke, image, {quoted: mek, caption: 'Here u go!😛'})
break
case 'hartatahta': 
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, harta, image, {quoted: mek, caption: 'Here u go!😛'})
break
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, pornhub, image, {caption: `Here u go!😛`, quoted: mek})
break
case 'pornhub':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, girlneko, image, {caption: `Here u go!😛`, quoted: mek})
break
case 'sadboy':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, girlneko2, image, {caption: `Here u go!😛`, quoted: mek})
break
case 'makerkaneki':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, girlneko8383, image, {caption: `Here u go!😛`, quoted: mek})
break
case 'rem':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, girlneko11111, image, {caption: `Here u go!😛`, quoted: mek})
break
case 'lolimaker':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, girlnekojkjk, image, {caption: `Here u go!😛`, quoted: mek})
break
case 'gura':
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, girlnekoooo, image, {caption: `Here u go!😛`, quoted: mek})
break
                         case 'wolf3':
                   ...
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anuwolf3, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it?`, quoted: mek})
                   break
                          case 't3d':
                   ...
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anut3d, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'logoa':
                   ...
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anulogoa, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'phlogo':  
                   ...
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anuphlogo, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'marvel3':
                   ...
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anumrvl3, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'leavest':  
                   if (args.length < 1) return reply(`[  ×  ] Example :\n*${prefix}${command} Xeon*`)
                   F = body.slice(9)
                   ...
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anulvst, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break                   
       case 'notewrite':
                   if (args.length < 1) return reply(`[  ×  ] Example :\n*${prefix}${command} Xeon*`)
                   F = body.slice(7)
                   ...
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anunw, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'neon2':
                   if (args.length < 1) return reply(`[  ×  ] Example :\n*${prefix}${command} Xeon*`)
                   F = body.slice(7)
                   ...
                   𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anunion2, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break 
...
+ 'VERSION:3.0\n'
+ `FN:${ownername}\n`
+ `ORG: Owner Of 𝙍𝘼𝙃𝙀𝙀𝙎e Bot ;\n`
+ `TEL;type=CELL;type=VOICE;waid=${owner}:${owner}\n`
+ 'END:VCARD'.trim()
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, {displayName: `The owner ${botname}`, vcard: vcard2}, contact, 
{ quoted: fgi, 
})
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, devsound, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek })
break
case 'sc':
case 'script':
case 'sourcode':
...
𝙍𝘼𝙃𝙀𝙀𝙎.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
break
...
await 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, ini_buffer, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek})
break
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, buff, image, {quoted: mek, caption : teks})
break
...
//══════════[ CONVERT FEATURES ]══════════//
      ...
      case 'squirrel':
        ...
        media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedia012)
        ran = getRandom('.mp3')
        exec(`ffmpeg -i ${media} -af atempo=1/2,asetrate=44500*2/1 ${ran}`, (err, stderr, stdout) => {
          fs.unlinkSync(media)
          if (err) return reply('Error!')
          hah = fs.readFileSync(ran)
          𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, hah, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek })
          fs.unlinkSync(ran)
        })
        break
      case 'blub':
        ...
        media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediakekek)
        ran = getRandom('.mp3')
      ...
      case 'ghost':
        ...
        media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedia777)
        ran = getRandom('.mp3')
      ...
      case 'cutesound':
        ...
        media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedia100)
        ran = getRandom('.mp3')
        exec(`ffmpeg -i ${media} -filter:a "atempo=1.0,asetrate=50000" ${ran}`, (err, stderr, stdout) => {
          fs.unlinkSync(media)
          if (err) return reply('Error!')
          riu = fs.readFileSync(ran)
          𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, riu, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek })
          fs.unlinkSync(ran)
        })
        break
case 'slowmo': case 'slow':{
								try {
										...
										media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedia22)
										ran = getRandom('.mp3')
										exec(`ffmpeg -i ${media} -filter:a "atempo=0.7,asetrate=44100" ${ran}`, (err, stderr, stdout) => {
											fs.unlinkSync(media)
											if (err) return reply('Error!')
											uhh = fs.readFileSync(ran)
											𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, uhh, audio, {mimetype: 'audio/mp4', ptt:true, quoted: mek})
											fs.unlinkSync(ran)
											})
											} catch (e) {
												reply('Error!')
...
case 'fast':{
									try {
										...
										media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedia11)
										ran = getRandom('.mp3')
...
case 'vibra': case 'vibrato':{
									...
									media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedia33)
									ran = getRandom('.mp3')
    ...
    case 'nightcore':            
		  ...
		  core = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(night)
		  ran = getRandom('.mp3')
		  reply(mess.wait)
		  ...
		  if (err) return reply('Error!')
		  hah = fs.readFileSync(ran)
		  𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:false, quoted: mek, ptt: true})
		  fs.unlinkSync(ran)
		  })
	      break
 case 'vnsec':
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					mediam = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediam)
					cokmatane = Number(args[0])
					hah = fs.readFileSync(mediam)
						𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: cokmatane, ptt: true, quoted:mek})
						fs.unlinkSync(mediam)
				break
				case 'vidsec':
				encmedian = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					median = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedian)
					cokmatane = Number(args[0])
					hah = fs.readFileSync(median)
						𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, hah, video, {mimetype: 'video/mp4', duration: cokmatane, quoted: mek})
						fs.unlinkSync(median)
				break
 case 'robot':
encmedial = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
medial = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedial)
ran = getRandom('.mp3')
exec(`ffmpeg -i ${medial} -filter_complex "afftfilt=real='hypot(re,im)*sin(0)':imag='hypot(re,im)*cos(0)':win_size=512:overlap=0.75" ${ran}`, (err, stderr, stdout) => {
fs.unlinkSync(medial)
if (err) return reply(mess.error.api)
hah = fs.readFileSync(ran)
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt:true, quoted: mek})
fs.unlinkSync(ran)
})
break
case 'fat':
					encmediaz = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					mediaz = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediaz)
					ran = getRandom('.mp3')
					exec(`ffmpeg -i ${mediaz} -filter:a "atempo=1.6,asetrate=22100" ${ran}`, (err, stderr, stdout) => {
						fs.unlinkSync(mediaz)
						if (err) return ephe('Error!')
						hah = fs.readFileSync(ran)
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, duration: 359996400, quoted:mek})
						fs.unlinkSync(ran)
					})
					break
case 'reverse':
	encmediau = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	mediau = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediau)
	ran = getRandom('.mp3')
...
case 'bass':                 
					...
					mediao = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediao)
					ran = getRandom('.mp3')
 ...
 case 'tomp3':
					...
					mediad = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediad)
					ran = getRandom('.mp4')
					exec(`ffmpeg -i ${mediad} ${ran}`, (err) => {
						fs.unlinkSync(mediad)
						if (err) return reply(mess.error.api)
						mhee = fs.readFileSync(ran)
						𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, mhee, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek })
						fs.unlinkSync(ran)
					})
					break
 case 'toimg':
...
media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediatoimg)
ran = getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) return reply('Failed, when converting sticker to image')
buffer = fs.readFileSync(ran)
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, buffer, image, {quoted: mek, caption: 'Here'})
fs.unlinkSync(ran)
})
break
case 'tts':
        ...
        if (args.length < 2) return 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, 'Where is the text bro??', text, {quoted: mek})
        ngab = budy.slice(7)
        ranm = getRandom('.mp3')
        rano = getRandom('.ogg')
        ngab.length > 600
        ...
        : gtts.save(ranm, ngab, function() {
            exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
                ...
                𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, buff, audio, {quoted:mek,ptt:true})
                fs.unlinkSync(rano)
            })
        })
...
break
    ...
    if ((isMedia && !mek.message.videoMessage || isQuotedImage || isQuotedVideo ) && args.length == 0) {
            ...
            owgi = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(boij)
...
//══════════[ LEVELING FEATURES ]══════════//
	...
	case 'level':
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, resul, text, { quoted: mek})
					.catch(async (err) => {
					console.error(err)
					await reply(`Error!\n${err}`)
					})
					...
					case 'profile':
					if (!isGroup) return reply(mess.group)
				    let anuprofileoke = await 𝙍𝘼𝙃𝙀𝙀𝙎.groupMetadata(from)
                    const thu = await 𝙍𝘼𝙃𝙀𝙀𝙎.getStatus(anuprofileoke.participants[0], MessageType.text)
    				𝙍𝘼𝙃𝙀𝙀𝙎.updatePresence(from, Presence.composing)
    				try {
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, buffer, image, {quoted: mek, caption: profile})
					break
...
case 'memegenerator': case 'memegen':{
									...
									try {
									   ...
									   var mediiia = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(enmediaokekek)
										...
										𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, resu, image, {caption:'.stikerin bang', thumbnail: Buffer.alloc(0), quoted: mek})
 	...
 	case 'stickermeme': case 'memesticker': case 'memestick': case 'stickmeme': case 'stcmeme': case 'smeme':{
						if (args.length < 1) return reply(`Send orders *${prefix + command}* 𝙍𝘼𝙃𝙀𝙀𝙎eBot`)
									...
									try {
										...
										var mediia = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(enmedialel)
...
case 'takesticker':
					case 'take':
						...
						const media2 = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediaoo1, `./sticker/${sender}`)
						const packname = ppp.split('|')[0]
						const author = ppp.split('|')[1]
						exif.create(packname, author, `takestick_${sender}`)
						exec(`webpmux -set exif ./sticker/takestick_${sender}.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
							if (error) return reply(mess.error.api)
							𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: mek})
...
case 'stickerwm':
					case 'swm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							const media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedia9191, `./sticker/${sender}`)
							...
							const media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediaokekak, `./sticker/${sender}`)
							...
							sticWait(from)
								await ffmpeg(`${media}`)
									...
									.on('end', function () {
										...
										exec(`webpmux -set exif ./sticker/stickwm_${sender}.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
											if (error) return reply(mess.error.api)
											𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: ftex})
											fs.unlinkSync(media)
											fs.unlinkSync(`./sticker/${sender}.webp`)
											fs.unlinkSync(`./sticker/stickwm_${sender}.exif`)
										})
...
const media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedialoli)
ran = '666.webp'
await ffmpeg(`./${media}`)
.input(media)
.on('start', function (cmd) {
...
.on('end', function () {
console.log('Finish')
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
.addOutputOptions([`-vcodec`, `libwebp`, `-vf`, `scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
...
const media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmedialoli22)
ran = '999.webp'
reply(mess.wait)
await ffmpeg(`./${media}`)
...
var media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(enmediahe1)
var njay = await imgbb('520bd6f6209077d1777c2a4f20c509c2', media)
var resu = await getBuffer(`https://api.memegen.link/images/custom/${teks1}/${teks2}.png?background=${njay.display_url}`)
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, resu, image, {quoted: mek})
fs.unlinkSync(media)
} catch (e) {
return reply(`${e}`)
console.log(e)
      ...
      if (!isGroup) return reply(mess.only.group)
        ...
        break
                  ...
                  sange = body.slice(1)
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, 'Question : *'+sange+'*\n\nAnswer: '+ nge+'%', text, { quoted: mek })
					break
                case 'gaycheck':
					// source code by xeon⛔
                  gayy = body.slice(1)
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, 'Question : *'+gayy+'*\n\nAnswer : '+ yag+'%', text, { quoted: mek })
					break
                case 'lesbicheck':
                case 'lesbiancheck':
					// source code by xeon⛔
                  lesbii = body.slice(1)
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, 'Question : *'+lesbii+'*\n\nAnswer : '+ bi+'%', text, { quoted: mek })
					break
                case 'handsomecheck':
					// source code by xeon⛔
ganteng = body.slice(1)
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, 'Question : *'+ganteng+'*\n\nAnswer : '+ teng+'%', text, { quoted: mek })
					break
		case 'beautycheck':
					// source code by xeon⛔
cantik = body.slice(1)
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, 'Question : *'+cantik+'*\n\nAnswer : '+ tik+'%', text, { quoted: mek })
					break
		case 'charactercheck':
					// source code by xeon⛔
watak = body.slice(1)
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, 'Question : *'+watak+'*\n\nAnswer : '+ tak, text, { quoted: mek })
				        break
...
//══════════[ GAME FEATURES ]══════════//
    ...
    "Pretending to be possessed, for example: possessed by 𝙍𝘼𝙃𝙀𝙀𝙎, possessed by grasshoppers, possessed by refrigerator, etc.",
...
case 'bc':
             ...
             if (args.length < 1) return reply('Where is the text?')
             anu100 = await 𝙍𝘼𝙃𝙀𝙀𝙎.chats.all()
             if (isMedia && !𝙍𝘼𝙃𝙀𝙀𝙎.message.videoMessage || isQuotedImage) {
             const encmediaboomb = isQuotedImage ? JSON.parse(JSON.stringify(𝙍𝘼𝙃𝙀𝙀𝙎).replace('quotedM','m')).message.extendedTextMessage.contextInfo : 𝙍𝘼𝙃𝙀𝙀𝙎
             bc100 = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(encmediaboomb)
             for (let _ of anu100) {
             𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(_.jid, bc100, image, {quoted: fgi, caption: `*「 𝙍𝘼𝙃𝙀𝙀𝙎e Bot Broadcast 」*\n\n${body.slice(4)}`})
}
             reply('Broadcast success')
             } else {
             for (let _ of anu100) {
             𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(_.jid, 
			{"contentText": `*「 𝙍𝘼𝙃𝙀𝙀𝙎E BOT BROADCASTING MESSAGE 」*\n\n${body.slice(4)}`,
			"footerText": `${tanggal}`,
			"buttons": [
...
buff = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(encmedia12345)
for (let _ of anubc2) {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(_.jid, buff, image, { viewOnce:true, caption: `${body.slice(4)}`})
}
...
buff = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(encmediaki)
for (let _ of anubc2) {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(_.jid, buff, video, { viewOnce:true, caption: `${body.slice(4)}`})
}
reply(`Broadcast success ${body.slice(4)}`)
} else if (isMedia && !mek.message.videoMessage || isQuotedVideo) {
...
buff = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(encmediadirk)
for (let _ of anubc2) {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(_.jid, buff, video, { mimetype: Mimetype.gif, quoted: finv, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: `${body.slice(4)}` })
}
reply(`Broadcast success ${body.slice(4)}`)
} else {
for (let _ of anubc2) {
...
bcgc = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(encmediabcgc)
for (let _ of groupMembers) {
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(_.jid, bcgc, image, { caption: `*「 𝙍𝘼𝙃𝙀𝙀𝙎E BOT BROADCAST 」*\n*Group* : ${groupName}\n\n${body.slice(6)}` })
}
reply('')
} else {
for (let _ of groupMembers) {
sendMess(_.jid, `*「 𝙍𝘼𝙃𝙀𝙀𝙎E BOT BROADCAST 」*\n*Group* : ${groupName}\n\n${body.slice(6)}`)
}
...
if (!isOwner && !mek.key.fromMe) return  reply(mess.only.owner)
anuclearall = await 𝙍𝘼𝙃𝙀𝙀𝙎.chats.all()
𝙍𝘼𝙃𝙀𝙀𝙎.setMaxListeners(25)
for (let _ of anuclearall) {
𝙍𝘼𝙃𝙀𝙀𝙎.deleteChat(_.jid)
}
...
media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(enmediaheheh, './database/sampah/media_user')
await 𝙍𝘼𝙃𝙀𝙀𝙎.updateProfilePicture(botNumber, media)
...
𝙍𝘼𝙃𝙀𝙀𝙎.updateProfileName(anuoke112)
...
if (!Number(oi2)) return reply('The number must be a number!')
	  for (let i = 0; i < oi2; i++) {
	  𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, `${oi1}`, MessageType.text)
	  }
...
if (Number(args[0]) >= 50) return reply('Max 50!')
	  ...
	  𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, teks, MessageType.text)
	  }
	...
	if (Number(args[0]) >= 50) return reply('Max 50!')
	  for (let i = 0; i < args[0]; i++) {
	  𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anutospem, sticker)
	  }
} else if (isQuotedAudio) {
	encmediat = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	            mediat = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediat)
				anutospem2 = fs.readFileSync(mediat)
	if (!Number(args[0])) return reply('Amount must be a number!')
	if (Number(args[0]) >= 50) return reply('Max 50!')
	  for (let i = 0; i < args[0]; i++) {
	  𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, anu2spem2, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt:true})
	  }
...
if (Number(oi2) >= 50) return reply('Max 50!')
	if (!Number(oi2)) return reply('Amount must be a number!')
	  for (let i = 0; i < oi2; i++) {
	  𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, delb, MessageType.image, {caption: oi1})
	  }
}
	  break
	case 'spam':
				...
				for (let i = 0; i < argzi[1]; i++){
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, argzi[0], MessageType.text)
				}
				break
				      case 'leaveall':
             if (!isOwner) return  reply(mess.only.owner)
             let totalgroup = 𝙍𝘼𝙃𝙀𝙀𝙎.chats.array.filter(u => u.jid.endsWith('@g.us')).map(u => u.jid)
             for (let id of totalgroup) {
             sendMess(id, 'byee!', null)
             𝙍𝘼𝙃𝙀𝙀𝙎.groupLeave(id)
}
             break
             case 'addvn':
					if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, `Success, please check with *${prefix}vnlist*`, MessageType.text, { quoted: mek })
					break
					case 'delvn':
					if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					try {
				...
				case 'listvn':
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": vien } })
					break
					case 'addimage':
				if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
				...
				case 'listimage':
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": imagi } })
					break
					case 'addsticker':
				if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					if (!isQuotedSticker) return reply('Reply sticker')
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, `Success, please check with *${prefix}liststicker*`, MessageType.text, { quoted: mek })
					break
				case 'delsticker':
				if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					try {
				...
				case 'liststicker':
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": setik } })
					break
					break
...
//══════════[ GROUP FEATURES ]══════════//
			...
			if (!isGroup) return reply(mess.only.group)
				...
				if (mek.message.extendedTextMessage != undefined){
					...
					𝙍𝘼𝙃𝙀𝙀𝙎.groupCreate(argz[0], anucgc)
					reply(`Success in creating a group ${argz[0]}`)
                }
				break
case 'getbio':
	  var yy = mek.message.extendedTextMessage.contextInfo.participant
var p = await 𝙍𝘼𝙃𝙀𝙀𝙎.getStatus(`${yy}`, MessageType.text)
reply(p.status)
if (p.status == 401) {
reply(mess.error.api)
}
...
case 'getdp':
            ...
            pictt = await 𝙍𝘼𝙃𝙀𝙀𝙎.getProfilePicture(mentioned)
            pict = await getBuffer(pictt)
            𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, pict, image, {quoted: mek})
            break
                    case 'getname':
        var ambl = mek.message.extendedTextMessage.contextInfo.participant
const sname = 𝙍𝘼𝙃𝙀𝙀𝙎.contacts[ambl] != undefined ? 𝙍𝘼𝙃𝙀𝙀𝙎.contacts[ambl].notify = undefined ? PhoneNumber('+' + ambl.replace('@s.whatsapp.net', '')).getNumber('international') : 𝙍𝘼𝙃𝙀𝙀𝙎.contacts[ambl].notify || 𝙍𝘼𝙃𝙀𝙀𝙎.contacts[ambl].vname : PhoneNumber('+' + ambl.replace('@s.whatsapp.net', '')).getNumber('international')
reply(sname)
break
case 'leave':
            if (!isGroup) return reply(mess.only.group)
                    if (isGroupAdmins || isOwner) {
                    	𝙍𝘼𝙃𝙀𝙀𝙎.groupLeave(from)
                    } else {
...
case 'getdescgc':
				...
				if (!isGroup) return reply(mess.only.group)
					anugetdescgc = from
			   metadete = await 𝙍𝘼𝙃𝙀𝙀𝙎.groupMetadata(anugetdescgc)
				𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, metadete.desc, text, {quoted:mek})
				  break
case 'nsfw':
...
await 𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, bMess, MessageType.buttonsMessage, {quoted: mek})
break
					case 'opengc':
					if (!isGroup) return reply(mess.only.group)
                   ...
                   reply(`Successful opening group ${groupName}`)
						𝙍𝘼𝙃𝙀𝙀𝙎.groupSettingChange(from, GroupSettingChange.messageSend, false)
						break
						case 'closegc':
						if (!isGroup) return reply(mess.only.group)
                   ...
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
						...
						𝙍𝘼𝙃𝙀𝙀𝙎.groupSettingChange(from, GroupSettingChange.messageSend, true)
					break
case 'grouplink':
case 'gruplink':
case 'gclink':
...
if (!isGroup) return reply(mess.only.group)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
linkgc = await 𝙍𝘼𝙃𝙀𝙀𝙎.groupInviteCode(from)
yeh = `https://chat.whatsapp.com/${linkgc}\n\n*${groupName}* group link`
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, yeh, text, { quoted: fgi })
break
case 'promote' :
...
𝙍𝘼𝙃𝙀𝙀𝙎.groupMakeAdmin(from, mentioned)
} else {
...
mentions(teks, mentioned, true)
𝙍𝘼𝙃𝙀𝙀𝙎.groupDemoteAdmin(from, mentioned)
} else {
...
𝙍𝘼𝙃𝙀𝙀𝙎.groupDemoteAdmin(from, members_id)
break
case 'promoteall':
...
𝙍𝘼𝙃𝙀𝙀𝙎.groupMakeAdmin(from, members_id)
break
case 'add' :
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
𝙍𝘼𝙃𝙀𝙀𝙎.groupUpdateSubject(from, `${body.slice(9)}`)
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, `\`\`\`Success ✅, Renamed the group to\`\`\` *${body.slice(9)}*`, text, { quoted: mek })
break
case 'setdesc':
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
𝙍𝘼𝙃𝙀𝙀𝙎.groupUpdateDescription(from, `${body.slice(9)}`)
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, `\`\`\`Success ✅, Changing group description\`\`\` *${groupMetadata.subject}* Became: *${body.slice(9)}*`, text, { quoted: fgi })
break
case 'setgrouppp':
case 'setgruppp':
case 'setpp':
...
let media = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadMediaMessage(encmediasetppgc)
𝙍𝘼𝙃𝙀𝙀𝙎.updateProfilePicture(from, media)
...
if (!isGroup) return reply(mess.only.group)
try {
var pic = await 𝙍𝘼𝙃𝙀𝙀𝙎.getProfilePicture(from)
} catch {
var pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
let ingfo = `*G R O U P I N F O*\n\n*Name :* ${groupName}\n*Group ID :* ${from}\n*Made :* ${moment(`${groupMetadata.creation}` * 1000).tz('Asia/Kolkata').format('DD/MM/YYYY HH:mm:ss')}\n*Group Owner :* @${groupMetadata.owner.split('@')[0]}\n*Number of Admins :* ${groupAdmins.length}\n*Number of participants :* ${groupMembers.length}\n*Welcome :* ${isWelkom ? 'Aktif' : 'Mati'}\n*AntiLink :* ${isAntiLink ? 'Aktif' : 'Mati'}\n*Desc :* \n\n${groupMetadata.desc}`
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, await getBuffer(pic), image, {quoted: mek, caption: ingfo, contextInfo: {"mentionedJid": [groupMetadata.owner.replace('@c.us', '@s.whatsapp.net')]}})
break
case 'resetlinkgc':
case 'resetlinkgroup':
case 'resetlinkgrup':
...
𝙍𝘼𝙃𝙀𝙀𝙎.query({json, expect200: true})
...
break
       ...
       case 'here':                
             ...
             let online = [...Object.keys(𝙍𝘼𝙃𝙀𝙀𝙎.chats.get(ido).presences), 𝙍𝘼𝙃𝙀𝙀𝙎.user.jid]
             𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, 'List Online:\n' + online.map(v => '- @' + v.replace(/@.+/, '')).join `\n`, text, { quoted: mek, contextInfo: { mentionedJid: online }})
             } catch (e) {
             reply(`${e}`)
}
             break
...
case 'sticktag':
            ...
            file = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
            value = args.join(" ")
            var group = await 𝙍𝘼𝙃𝙀𝙀𝙎.groupMetadata(from)
            ...
            𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, ini_buffer, sticker, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, ini_buffer, image, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, ini_buffer, audio, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, ini_buffer, video, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, ini_buffer, document, options)
            fs.unlinkSync(file)
        }  else if ((isMedia && !mek.message.videoMessage || isQuotedVideo) && args.length == 0) {
            encmediau = isQuotedVideo ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
            file = await 𝙍𝘼𝙃𝙀𝙀𝙎.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
...
𝙍𝘼𝙃𝙀𝙀𝙎.sendMessage(from, options, text, { quoted: mek })
break
case 'contag':
